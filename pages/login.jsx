...
export default function Login() {
  ...
  const users = [
    ...
    { login: 150655, password: "BRUNO CESAR" },
    { login: 238885, password: "CAIO VITOR" },
    ...
    { login: 198337, password: "ERIVALDO" },
    ...
    { login: 147938, password: "ISLANIA OLIVEIRA" },
    { login: 57612, password: "JOAO COSTA" },
    { login: 88, password: "JOAO EMIDIO" },
    { login: 186111, password: "LEIDE" },
    { login: 87, password: "LEONARDO" },
    { login: 110000001, password: "LIEBE" },
    { login: 32098, password: "LIEBE" },
    { login: 215966, password: "LUCIANO" },
    { login: 153281, password: "LUIS" },
    { login: 210491, password: "LUIS" },
    { login: 235053, password: "LUIZ" },
    { login: 102096, password: "LURDES" },
    { login: 31237, password: "MAGAZINES" },
    { login: 262470, password: "MARCO" },
    { login: 160518, password: "MARCO" },
    { login: 103, password: "MARISTELA" },
    { login: 98, password: "MURILO" },
    { login: 248902, password: "NEILSON" },
    { login: 173283, password: "PAULO" },
    { login: 101563, password: "RAFAELA" },
    { login: 229218, password: "ROSI" }
